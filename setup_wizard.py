...
def save_configuration(site_numbers, latitude=None, longitude=None, radius=25):
    """
...
def run_wizard():
    ...
    if selected_sites:
        ...
        if confirm == 'y':
            save_configuration(selected_sites, latitude, longitude, radius)
        ...
        # Save empty config
        save_configuration([], latitude, longitude, 25)
